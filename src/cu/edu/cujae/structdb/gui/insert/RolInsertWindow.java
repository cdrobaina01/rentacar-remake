...
public class RolInsertWindow extends JDialog {
    ...
    private void initComponents() {
        ...
        //======== dialogPane ========
        {
            ...
            .swing.border.TitledBorder.CENTER,javax.swing.border.TitledBorder.BOTTOM,new Font("D\u0069alog", Font.BOLD,12), Color.red),dialogPane. getBorder()));dialogPane. addPropertyChangeListener(new java.beans.
